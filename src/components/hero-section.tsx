        ...
        <div className="text-center animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Cornell CS student passionate about blockchain, fintech, and building innovative solutions. 
              Co-founder with proven track record in fundraising, product management, and technical development.
            </p>
          </div>
